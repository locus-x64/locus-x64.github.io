...
% this could be LinkedIn, GitHub, or a personal website or social media account (if used for professional purposes)
    \large{Github}: \href{https://github.com/alirazamumtaz}{alirazamumtaz} \\
    \large{LinkedIn}: \href{https://www.linkedin.com/in/alirazamumtaz}{alirazamumtaz} \\
    \large{Webiste}: \href{https://alirazamumtaz.me}{alirazamumtaz.me} \\
...
I am interested in the security vulnerabilities posed by systems and language formal specifications, and how they can be exploited.
For now, I am working on my FYP thesis that is about reproducing CVE-2019-2215 which is the Use After Free vulnerability in Android Kernel’s Binder IPC subsystem.
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalsize{\item{
     ...
     \textbf{OS}{: GNU/Linux, MacOS, Windows + WSL} \\
    }}
 \end{itemize}
\end{document}
...
\resumeSubHeadingListStart
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{Basic *nix shell with some builtin commands}
            \resumeItemListEnd
        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \small\resumeItem{An assembler for hack assembly}
            \resumeItemListEnd
