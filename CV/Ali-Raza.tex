...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \item Conducted targeted fuzzing (AFL++, syzkaller) across userland and the Linux kernel; triaged crashes, minimized inputs, and authored PoCs
        \item Discovered and disclosed 0-day in zlog (CVE-2024-22857) via AFL++; developed a PoC exploit and proposed remediation, working with maintainers through coordinated disclosure
        \item Discovered and disclosed a 0-day in \texttt{python-socketio} (CVE-2025-61765) with a PoC and remediation guidance, coordinating with the maintainer
        \item Discovered and disclosed 0-day in MindsDB (CVE-2025-68472) with a detailed report and suggested a fix for the vulnerability
        \item Performed secure code reviews and static analysis of C/C++ codebases using CodeQL and manual auditing; hardened CPython against classes of memory corruption
        \item Reverse engineered firmware and system components with IDA Pro and Ghidra to pinpoint vulnerable code paths and exploitation primitives
      ...
      \resumeSubheading
      {{Redseclabs (Pvt.) Ltd. [\href{https://www.redseclabs.com/}{\faIcon{globe}}]}}{Contract - Remote}
      {Vulnerability Researcher}{July 2025 - December 2025}
      \resumeItemListStart
        \item Initially worked on Android kernel n-day exploitation, then later shifted to Ubuntu-specific Linux kernel n-day research
        \item Worked on local privilege escalation (LPE) via Ubuntu system applications (e.g., D-Bus, Apport, etc)
        \item Subsequently analyzed PureVPN for the same objective
      \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \item Designed lab coursework and assessments
      \item Provided hands-on guidance and mentorship to students
    \resumeItemListEnd
...
\resumeResearchExp
{0-day in OpenClaw(clawbot): CVE-2026-26972 \href{https://github.com/openclaw/openclaw/security/advisories/GHSA-xwjm-j929-xq7c}{[\faIcon{globe}]}}
{
  \resumeItemListStart
  \item Discovered path traversal in OpenClaw/Clawbot API that enabled arbitrary file read/write and command execution
  \item Built and shared a PoC with maintainers; provided remediation guidance and coordinated disclosure timelines
  \item Tools: semgrep, copilot
  \resumeItemListEnd
}

\resumeResearchExp
{0-day in MindsDB: CVE-2025-68472 \href{https://github.com/mindsdb/mindsdb/security/advisories/GHSA-qqhf-pm3j-96g7}{[\faIcon{globe}]}}
{
  \resumeItemListStart
  \item Identified improper sanitization of a parsed path, leading to arbitrary file read and removal
  \item Coordinated with the maintainers by providing a PoC and recommendations to fix the vulnerability
  \item Tools: Python, Git
  \resumeItemListEnd
}
...
\resumeItemListStart
  ...
  \item Wrote a blog post and had it published on the client's website \href{https://www.bluerock.io/post/cve-2025-61765-bluerock-discovers-critical-rce-in-socket-io-ecosystem}{[\faIcon{globe}]}
  \item Tools: Python, pytest, Git
\resumeItemListEnd
}
...
\resumeItemListStart
  ...
  \item Analyzed the PAL allocator and identified vulnerable code paths for the CVE statically
