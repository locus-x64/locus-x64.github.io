...
I am interested in finding security vulnerabilities posed by Operating Systems and how they can be exploited. As a Malware Researcher at Ebryx, I focus on Linux Kernel Exploitation, specializing in n-day research. I aim to transition towards zero-day discovery and proficiently craft Proof of Concepts (PoC) and exploits for the Linux Kernel.
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        {Punjab Group of Colleges, Okara Campus}{August 2017 - 2019}
...
\researchHeading
    {0day Day in zlog - CVE-2021-41073}
    {November, 2023 -- Present}
    {Ebryx (Pvt.) Ltd.}
    \resumeItemListStart
        \resumeItem{Collaborator: \href{https://www.linkedin.com/in/faran-abdullah/}{Faran Abdullah}}
        \resumeItem{Found bug in zlog}
        \resumeItem{Wrote PoC}
        \resumeItem{Submitted to MITRE}
        \resumeItem{Reserved CVE number - CVE-2024-22857}
        \resumeItem{Submitted to zlog maintainers and waiting to be published}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        {Freelance on Fiverr}{\href{https://www.fiverr.com/alirazamumtaz/}{Profile}}
        \resumeItemListStart
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        ...
        {Google Developer Student Clubs}{2021 -- 2022 \& 2022 -- 2023}
        \resumeItemListStart
    ...
    \resumeSubheading
        ...
        {Event Management Society}{2020 -- 2021 \& 2022 -- 2023}
        \resumeItemListStart
